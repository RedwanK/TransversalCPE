 ...
 */
final class Version20201208161013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE incident (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, latitude INT NOT NULL, longitude INT NOT NULL, intensity INT NOT NULL, INDEX IDX_3D03A11A8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
